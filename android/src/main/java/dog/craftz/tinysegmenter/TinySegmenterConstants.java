...
public class TinySegmenterConstants
{
    ...
    public static final String[] BW1_KEYS = {"引き","から","いう","を見","平方","B1同","てい","たち","大阪","Ｂ１あ","ませ","取り","には","てき","すで","毎日","どこ","なん","さら","こと","まで","の中","そこ","いっ","がら","とみ","さん","にも","った","ない","」と","つい","ため","した","うん","本当","でき","、と","やむ","よっ","まま","して","、同","に対","亡く","Ｂ１同","｣と","です","大き","B1あ","をし","あっ","まる","京都","こん","なっ","とい","いる",",と","れた","など",",同","の一","目指","うし","れで","では","それ","こう","にし","日本"};
    ...
    public static final String[] UW1_KEYS = {"京","あ","委","う","が","き","｢","こ","･","大","区","市","、","国","午","で","と","ど",",","に","「","の","は","日","生","理","都","も","や","よ","ら","県","り","主","れ","を","ん","・"};
    ...
    public static final String[] UW2_KEYS = {"揺","市","も","会","や","保","よ","最","り","初","る","れ","文","第","入","を","ん","自","ア","朝",",","カ","キ","事","本","西","新","｢","｣","、","見","ッ","ｯ","北","〇","ｱ","小","子","「","ｶ","」","目","ｷ","開","相","間","副","大","学","天","太","理","人","区","県","日","立","次","三","年","不","強","東","込","世","あ","行","い","う","政","お","か","が","手","く","こ","中","さ","ざ","明","し","発","実","す","米","せ","そ","た","だ","民","主","つ","て","果","で","気","と","ど","な","議","に","の","は","ひ","調","べ","ま"};
    ...
    public static final String[] UW5_KEYS = {"み","市","1","め","ゃ","会","党","ょ","務","り","る","Ｅ２","れ","嵐","田","わ","郎","月","を","ん","町","題","統","空","イ","席",",",".","館","新","｢","長","、","。","査","ｲ","「","京","相","E2","間","]","大","学","省","社","区","県","ル","日","機","ﾙ","者","年","ﾝ","ン","選","あ","所","い","う","格","え","お","か","が","き","ぎ","く","員","げ","定","中","さ","し","語","す","挙","思","表","氏","だ","ち","的","っ","つ","て","１","で","と","ど","な","議","に","の","は","研","べ","告"};
    ...
    public static final String[] UW6_KEYS = {"1","E1","あ","空","委","う","業","か","が","会","く","一","郎","こ","じ","区","す","学","Ｅ１","市","１","た","、","。","っ","連","て","で","と",",","な","に","後",".","の","は","福","相","中","広","も","社","員","ﾙ","前","件","り","る","ﾝ","ル","を","ン","者"};
